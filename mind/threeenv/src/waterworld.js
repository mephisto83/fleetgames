...
var Eye = function (angle, max_range) {
    this.angle = angle; // angle relative to agent its on
    this.max_range = 120;
    this.sensed_proximity = max_range || 120; // what the eye is seeing. will be set in world.tick()
...
var Agent = function (ops) {
    ...
    this.rad = 10;
    this.eyes = [];
    for (var k = 0; k < 30; k++) { this.eyes.push(new Eye(k * 0.21, ops.eye)); }
